...
hl.on("hyprland.start", function () 
    hl.exec_cmd("waybar")
    hl.exec_cmd("wlsunset -l 43.814200 -L 18.569600 -t 2300")
    hl.exec_cmd("udiskie")
...
hl.bind(mainMod .. " + comma", hl.dsp.exec_cmd(
    "rofimoji --selector fuzzel --skin-tone neutral --prompt \"> \" --typer ydotool --action copy"
))

hl.bind("Print", hl.dsp.exec_cmd(
    "sh -c 'img=$(slurp) && grim -c -g \"$img\" - > /tmp/ss.png && wl-copy < /tmp/ss.png && mv /tmp/ss.png ~/Pictures/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png'"
), { locked = true })

hl.bind("SHIFT + Print", hl.dsp.exec_cmd(
    "sh -c 'grim -c - > /tmp/ss.png && wl-copy < /tmp/ss.png && mv /tmp/ss.png ~/Pictures/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png'"
), { locked = true })
